...
- [ ] **Phase 1: Package Skeleton & Tooling** - src-layout packages, pyproject.toml with hatchling, mypy/ruff/pytest config, and mcp pin
...
|-------|----------------|--------|-----------|
| 1. Package Skeleton & Tooling | 0/0 | Not started | - |
